        ...
        <form onSubmit={next} className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              ...
              <input value={name} onChange={e=>setName(e.target.value)} className="w-full rounded border border-slate-300 dark:border-neutral-700 bg-white dark:bg-neutral-950 px-3 py-2" placeholder="Acme Co."/>
            </div>
            <div>
              <label className="text-sm block mb-1">Industry</label>
              <input value={industry} onChange={e=>setIndustry(e.target.value)} className="w-full rounded border border-slate-300 dark:border-neutral-700 bg-white dark:bg-neutral-950 px-3 py-2" placeholder="Skincare, SaaS, etc."/>
            </div>
            <div>
          ...
          <div>
            ...
            <div className="mt-6 p-3 rounded border border-slate-200 dark:border-neutral-800" style={{borderColor: color}}>
              ...
              <div className="text-sm mt-1 text-slate-600 dark:text-slate-300">{persona || 'We will infer your brand persona...'}</div>
            </div>
          </div>

          <div className="md:col-span-2 flex justify-end">
            <button className="btn-primary">{loading ? 'Analyzing...' : 'Continue to discovery'}</button>
          </div>
        </form>
      </div>
    </div>
